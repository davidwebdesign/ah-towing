  ...
  return (
    <>
      <Head>
        ...
        {/* (Optional) SEO extras: */}
        <meta property="og:title" content="A&H Towing & Recovery — 24/7 Fast Tow Service" />
        <meta property="og:description" content="Direct line to dispatcher. Light & heavy duty towing, lockouts, jumpstarts, winching." />
      ...
      <section className="section">
        <div className="container grid grid-2" style={{alignItems:'center'}}>
          <div className="aspect-video"><FeaturedCarousel /></div>
          <div>
